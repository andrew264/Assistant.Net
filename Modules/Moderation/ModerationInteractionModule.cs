    ...
    : InteractionModuleBase<SocketInteractionContext>
{
        ...
        int count)
    {
        ...
        try
        {
            messagesToDelete = await Context.Channel.GetMessagesAsync(count).FlattenAsync();
        ...
        catch (Exception ex)
        {
            ...
            await FollowupAsync("Failed to fetch messages to delete.", ephemeral: true);
            return;
        }
        ...
        try
        {
            await textChannel.DeleteMessagesAsync(messagesList);
        ...
        catch (HttpException ex) when (ex.HttpCode == HttpStatusCode.Forbidden)
        {
            ...
            await FollowupAsync("I don't have permission to delete messages.", ephemeral: true);
        }
