...
public class ColorRoleModule(IOptions<DiscordOptions> options, ILogger<ColorRoleModule> logger)
    : InteractionModuleBase<SocketInteractionContext>
{
    ...
    {
        if (Context.Guild.Id != options.Value.HomeGuildId)
        {
    ...
    public async Task HandleColorRoleButtonAsync()
    {
        ...
        // --- Guild Check ---
        if (Context.Guild == null || Context.Guild.Id != options.Value.HomeGuildId)
        {
