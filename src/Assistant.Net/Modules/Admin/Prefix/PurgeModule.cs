...
public class PurgeModule(ILogger<PurgeModule> logger, IOptions<DiscordOptions> options)
    : ModuleBase<SocketCommandContext>
{
    ...
    public async Task PurgeUserAsync([Remainder] string? rawArgs = null)
    {
        ...
        {
            await ReplyAsync(
                    $"Usage: `{options.Value.Prefix}purgeuser [userId] [comma,separated,keywords]` or `{options.Value.Prefix}purgeuser [comma,separated,keywords]`")
